CREATE TABLE APP.Region (
	...
	codIso VARCHAR(100) NOT NULL,
	CONSTRAINT REGION_PK PRIMARY KEY (id)
);

CREATE TABLE App.Provincia (
	id INTEGER NOT NULL,
	nombre VARCHAR(100) NOT NULL,
	idRegion INTEGER NOT NULL,
	CONSTRAINT Provincia_PK PRIMARY KEY (id),
	CONSTRAINT Provincia_FK FOREIGN KEY (idRegion) REFERENCES Region(id)
);
...
CREATE TABLE Comuna (
	...
	CONSTRAINT Comuna_FK FOREIGN KEY (idProvincia) REFERENCES Provincia(id)
);
